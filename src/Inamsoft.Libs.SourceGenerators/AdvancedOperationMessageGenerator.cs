...
public sealed class AdvancedOperationMessageGenerator : GeneratorBase, IIncrementalGenerator
{
    ...
    public void Initialize(IncrementalGeneratorInitializationContext context)
    {
        ...
        //context.RegisterSourceOutput(enumDeclarations.Collect(), Generate);
        context.RegisterSourceOutput(enumDeclarations.Collect(), static (spc, enums, typeSymbol) =>
        {
            var source = GenerateCodeCode(spc, enums, typeSymbol!);
            //var source = GenerateExtensionsFor(typeSymbol!);
            spc.AddSource("OperationMessages.g.cs", (string)source);
        });
    }
